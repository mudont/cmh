...
teamsBlockContents =
    ...
    , Block.custom <|
        ...
        , tbody =
            Table.tbody []
                [ Table.tr []
                    [ Table.td [] [a [href ""] [text "USTA 4.0 18+"]]
                    , Table.td [] [text "Ashok Selvaraj"]
                    ]
                , Table.tr []
                    [ Table.td [] [a [href ""] [text "USTA 4.0 40+"]]
                    , Table.td [] [text "Bryan Botsch"]
                    ]
                , Table.tr []
                    [ Table.td [] [a [href ""] [text "USTA 3.5 18+"]]
                    , Table.td [] [text "Gopal Thirukulam"]
                    ]
                , Table.tr []
                    [ Table.td [] [a [href ""] [text "USTA 3.5 40+"]]
                    , Table.td [] [text "???"]
                    ]
                ]
        }
